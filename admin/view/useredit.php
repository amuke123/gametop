<div class="c_right">
	<div class="main">
		<div class="m_title"><?php echo $action=='add'?'添加用户':'修改用户资料';?></div>
		<div class="m_add2">
			<div class="cont">
			<?php $photo = ADMIN_URL .'/view/static/images/avatar.jpg';?>
			<form action="" method="post" name="useradd" onSubmit="return yzUserAdd();" >
				...
				<?php if($action=='edit'){?>
					<p><b>原密码:</b><input name="password" type="password" autocomplete="off" class="long" placeholder="原密码" /></p>
				<?php }?>
