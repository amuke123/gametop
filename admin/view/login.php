	...
	<div class="loginc">
		...
		<div class="l_form">
			...
			<form action='' method='post' name='login'>
				<p><i class="icon icon-user"></i><input type="text" name="username" class="form_full" required placeholder="用户ID/邮箱/手机号" /></p>
