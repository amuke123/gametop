	...
	<div class="main">
		...
		<div class="m_add2">
			<form action="" method="post" name="sortadd" onSubmit="return yzSortAdd();" enctype="multipart/form-data" >
				...
				<p><input type="text" class="formput" name="name" value="<?php echo $sorts[$sortid]['sortname'];?>" placeholder="名称" /></p>
				<p><input type="text" class="formput" name="alias" value="<?php echo $sorts[$sortid]['alias'];?>" placeholder="别名" /></p>
				...
				<div class="group">
					<p><b>分类图片</b><img <?php echo $sorts[$sortid]['pic']==""?ADMIN_URL .'src="view/static/images/img.gif" title="无图"':'src="'.$sorts[$sortid]['pic'].'"';?> /><input type="hidden" name="pic2" value="<?php echo $sorts[$sortid]['pic'];?>" /></p>
				...
				<p>
					<select name="group" class="formsele">
						...
						<option value='1' <?php echo $sorts[$sortid]['group']=='1'?'selected':'';?>>游戏</option>
					</select>
				</p>
